...
APPID="nwc" # one-word lower-case no-specials
...
GITHUB_REPO="https://github.com/Fierillo/nostr-wallet-connect"
...
if [ "$1" = "1" ] || [ "$1" = "on" ]; then
  ...
  echo "DATABASE_URI=file:/mnt/hdd/app-data/${APPID}/db/nwc.db
NOSTR_PRIVKEY=$(openssl rand -hex 32)
COOKIE_SECRET=$(openssl rand -hex 32)
RELAY=wss://relay.getalby.com/v1
PORT=${PORT_CLEAR}
LN_BACKEND_TYPE=LND
LND_ADDRESS=127.0.0.1:10009
LND_CERT_FILE=/mnt/hdd/lnd/tls.cert
LND_MACAROON_FILE=/mnt/hdd/lnd/data/chain/bitcoin/mainnet/admin.macaroon" | sudo -u ${APPID} tee /home/${APPID}/${APPID}/.env || {
...
EnvironmentFile=/home/${APPID}/${APPID}/.env
ExecStartPre=-/home/admin/config.scripts/bonus.${APPID}.sh prestart
ExecStart=/home/${APPID}/${APPID}/nostr-wallet-connect-arm64
User=${APPID}
Restart=always
TimeoutSec=120
RestartSec=30
